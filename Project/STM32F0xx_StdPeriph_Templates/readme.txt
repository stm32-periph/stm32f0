...
This example is used as a template project that can be used as refrence to build
any new firmware development for STM32F0xx devices using the STM32F0xx Standard
Peripherals Library.
...
TrueSTUDIO toolchains that compile the needed STM32F0xx Standard Peripheral's 
