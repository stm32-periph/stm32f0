...
This project contains 5 workspace as follows: 
...
This folder contains standard template projects for EWARM, MDK-ARM, RIDE
and TrueSTUDIO toolchains that compile the needed STM32F0xx Standard Peripheral's 
