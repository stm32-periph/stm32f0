/**
  ...
  *          ===================================================================
  *          Notes: 
  *           - This driver runs only on the STM320518-EVAL RevB
  *          ===================================================================
  *     
  ******************************************************************************
  * @attention
...
/** @defgroup STM320518_EVAL_CEC
  ...
  *        of STM320518-EVAL board.
  * @{
  */

/** @defgroup STM320518_EVAL_CEC_Private_Types
  * @{
  */
...
/** @defgroup STM320518_EVAL_CEC_Private_Defines
  * @{
  */
...
/** @defgroup STM320518_EVAL_CEC_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM320518_EVAL_CEC_Private_Variables
  * @{
  */
...
/** @defgroup STM320518_EVAL_CEC_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup STM320518_EVAL_CEC_Private_Functions
  * @{
  */
...
HDMI_CEC_Error HDMI_CEC_Init(void)
{
  ...
  GPIO_PinAFConfig(HDMI_CEC_LINE_GPIO_PORT, GPIO_PinSource10, GPIO_AF_0); 
