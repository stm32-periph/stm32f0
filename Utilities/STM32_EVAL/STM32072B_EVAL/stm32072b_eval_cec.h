/**
  ******************************************************************************
  * @file    stm32072b_eval_cec.h
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    13-October-2021
  * @brief   This file contains all the functions prototypes for the stm32072b_eval_cec
  *          firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32072B_EVAL_CEC_H
#define __STM32072B_EVAL_CEC_H
...
/**
  ...
  *         If you want to configure the STM32072B_EVAL board as CEC Root (Sink)
