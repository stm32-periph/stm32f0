/**
  ...
  *          performed in sEE_LowLevel_Init() function declared in stm32072b_eval.c 
  *          file.
...
/** @defgroup STM32072B_EVAL_I2C_EE_Private_Functions
  * @{
  */ 
