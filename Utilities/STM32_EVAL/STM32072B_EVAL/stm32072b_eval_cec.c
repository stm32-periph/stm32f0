/**
  ******************************************************************************
  * @file    stm32072b_eval_cec.c
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    13-October-2021
  * @brief   This file provides all the STM32072B-EVAL HDMI-CEC firmware functions.
  *
  *          ===================================================================
  *          Notes: 
  *           - This driver runs only on the STM32072B-EVAL
  *          ===================================================================
  *     
  ******************************************************************************
  * @attention
...
/** @defgroup STM32072B_EVAL_CEC_Private_Functions
  * @{
  */
...
HDMI_CEC_Error HDMI_CEC_Init(void)
{
  ...
  GPIO_PinAFConfig(HDMI_CEC_LINE_GPIO_PORT, GPIO_PinSource8, GPIO_AF_0); 
...
/**
  * @brief  Transmit message by taking data from typedef struct CEC_Message
...
/**
  ...
  * @note   When receiving the STANDBY Opcode command, the system is entered in
...
void HDMI_CEC_CommandCallBack(void)
{
  ...
  switch (HDMI_CEC_RX_MessageStructPrivate.Opcode)
  {
    ...
    case HDMI_CEC_OPCODE_GIVE_OSD_NAME:
      /* Send the OSD name = STM32072B CEC */
      HDMI_CEC_TX_MessageStructPrivate.Header = ((MyLogicalAddress << 4) | HDMI_CEC_RX_MessageStructPrivate.Header >> 4);
      ...
      HDMI_CEC_TX_MessageStructPrivate.Operande[5] = 0x30;
      HDMI_CEC_TX_MessageStructPrivate.Operande[6] = 0x35;
      HDMI_CEC_TX_MessageStructPrivate.Operande[7] = 0x31;
      HDMI_CEC_TX_MessageStructPrivate.Operande[8] = 0x38;
...
static HDMI_CEC_Error SinkPhysicalAddressDiscovery(void)
{
  ...
  GPIO_PinAFConfig(HDMI_CEC_SINK_I2C_GPIO_PORT, HDMI_CEC_SINK_I2C_SCL_PIN_SOURCE, GPIO_AF_5); 
  GPIO_PinAFConfig(HDMI_CEC_SINK_I2C_GPIO_PORT, HDMI_CEC_SINK_I2C_SDA_PIN_SOURCE, GPIO_AF_5);   
  
  /* Set PB13/PB14 as OD AF - I2C2_SCL/I2C2_SDA of Source*/
  ...
  /* Set the Hot plug detect signal */
  HDMI_CEC_HPD_HIGH(); 
  ...
  while(GPIO_ReadInputDataBit(HDMI_CEC_HPD_SINK_GPIO_PORT, HDMI_CEC_HPD_SINK_PIN) == RESET)
  {
  }
