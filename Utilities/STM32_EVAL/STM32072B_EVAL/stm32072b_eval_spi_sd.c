/**
  ...
  *          performed in SD_LowLevel_Init() function declared in stm32072b_eval.c 
  *          file.
...
/** @addtogroup STM32072B_EVAL_SPI_SD
  * @brief      This file includes the SD card driver of STM32072B-EVAL boards.
  * @{
  */ 
