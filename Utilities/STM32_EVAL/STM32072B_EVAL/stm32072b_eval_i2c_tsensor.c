/**
  ******************************************************************************
  * @file    stm32072b_eval_i2c_tsensor.c
  ...
  *          performed in LM75_LowLevel_Init() function declared in stm32072b_eval.c 
  *          file.
...
/* Includes ------------------------------------------------------------------*/
#include "stm32072b_eval_i2c_tsensor.h"
...
/** @defgroup STM32072B_EVAL_I2C_TSENSOR_Private_Functions
  * @{
  */ 
